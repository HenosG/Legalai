...
export default function CalendarSync() {
  ...
  return (
    // The main container now only needs padding since App.tsx handles the sidebar flex
    <div className="p-8 max-w-[1600px] mx-auto space-y-8 animate-in fade-in duration-500">
      
      {/* Page Header */}
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-slate-100 pb-8">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">Calendar Sync</h1>
          <p className="text-slate-500 mt-2 text-sm font-medium">
            Manage your legal deadlines and court dates across platforms.
          </p>
        </div>
        
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 bg-white border border-slate-200 text-slate-600 px-4 py-2.5 rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-slate-50 transition-all">
            <RefreshCw className="w-3.5 h-3.5" />
            Sync Now
          </button>
          <button className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2.5 rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20">
      ...
      <FeatureGuard 
        ...
        description="Sync your court dates and deadlines with Google Calendar and Outlook."
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Integration Card Example */}
          <div className="group p-6 bg-white border border-slate-200 rounded-2xl shadow-sm hover:border-blue-200 hover:shadow-md transition-all">
             <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
               <Calendar className="text-blue-600 w-6 h-6" />
             </div>
             <h3 className="font-bold text-slate-900">Google Calendar</h3>
             <p className="text-xs text-slate-400 mt-1 mb-4">Last synced: 5 minutes ago</p>
          ...
          {/* Placeholder for empty state or more integrations */}
          <div className="p-6 bg-slate-50 border border-dashed border-slate-300 rounded-2xl flex flex-col items-center justify-center text-center opacity-60">
            <Plus className="text-slate-400 mb-2" />
            <p className="text-xs font-bold text-slate-500 uppercase tracking-tight">Add Outlook</p>
          </div>
        </div>
      </FeatureGuard>
    </div>
